...
file = 'vert_membrane_nogrid.mat'
Pabs,x,y,f = load_mat(path+file)
Pabsv = Pabs
Pabsh = Pabs
...
#plt.show()
plt.savefig(path + "test.png", dpi=1200)
plt.savefig(path + "test.eps", dpi=1200)
plt.close()