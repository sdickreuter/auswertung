...
for sample in samples:
    ...
    files, ids, xy = make_plotmap(savedir, nx, ny, minwl, maxwl)
    ...
    for i in range(len(files)):
        ...
        wl, bg = np.loadtxt(open(savedir_bgs + file, "rb"), delimiter=",", skiprows=16, unpack=True)
